...
namespace ORB_SLAM2 {
    ...
    void System::SetORBVocabulary(ORBVocabulary *voc) {
        ...
        mpLoopCloser->SetORBVocabulary(mpVocabulary);
        mpTracker->SetORBVocabulary(mpVocabulary);
    }

    void System::SaveORBVocabulary(std::string file_name) {
        mpVocabulary->saveToTextFile(file_name);
    }
