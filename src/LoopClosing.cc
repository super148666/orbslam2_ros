...
namespace ORB_SLAM2 {
    ...
    void LoopClosing::SetMap(Map *map) {
        mpMap = map;
    }
    ...
    void LoopClosing::load(boost::archive::binary_iarchive &ar, const unsigned int version) {
        ...
        ar & idVector;
        mvpEnoughConsistentCandidates = createObjectList<KeyFrame>(idVector);
        ar & idVector;
        mvpCurrentConnectedKFs = createObjectList<KeyFrame>(idVector);
        ar & idVector;
    ...
    void LoopClosing::SetORBVocabulary(ORBVocabulary *orbVocabulary) {
